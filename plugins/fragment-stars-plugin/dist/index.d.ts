...
export declare function migrate(db: RuntimeSdk["db"]): void;
export declare function start(ctx: PluginContext): Promise<void>;
export declare const tools: (sdk: RuntimeSdk) => ({
    name: string;
    description: string;
    parameters: {
        type: string;
